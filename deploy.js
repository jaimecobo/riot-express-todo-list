...
function sshConnect() {
  ...
  ssh
    .connect({
      // TODO: ADD YOUR IP ADDRESS BELOW (e.g. '12.34.5.67')																	// ########### HERE CHANGE SERVER IP ADDRESS ##########
      host: '44.203.156.190',
      username: 'ubuntu',
      privateKey: 'C:\Users\jaime\Desktop\WOZ-U\ADN108 - DevOps\example-key.ppk'												// ########## HERE CHANGE PRIVATE KEY LOCATION ##########
    })
    .then(function() {
